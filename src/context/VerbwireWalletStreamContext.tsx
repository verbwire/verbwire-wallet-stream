...
interface VerbwireWalletStreamContextValue {
    apiKey: string;
    applicationId: string;
    watchAccount: (callback: any, config?: any) => () => void;
}
...
const VerbwireWalletStreamContext = createContext<VerbwireWalletStreamContextValue | null>(null);
...
const VerbwireWalletStreamContextProvider: React.FC<VerbwireWalletStreamContextProps> = ({ apiKey, applicationId, watchAccount, children }) => {
    ...
    return (
        <VerbwireWalletStreamContext.Provider value={{ apiKey, applicationId }}>
            {children}
        </VerbwireWalletStreamContext.Provider>
    )
}
